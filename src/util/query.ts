...
export function querySelectorWith<T extends Element = Element>(node: ParentNode, selector: string): T | null;
...
export function querySelectorAllWith<T extends Element = Element>(node: ParentNode, selector: string): T[];
